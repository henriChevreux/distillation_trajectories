...
def main():
    ...
    try:
        ...
        if args.only_denoising:
            ...
            print(f"Denoising samples shape: {fixed_test_samples[:args.num_denoising_samples].shape}")
            ...
            create_denoising_comparison_plot(
                ...
                config,
                os.path.join(config.analysis_dir, "denoising_comparison"),
                device
            )
            sys.exit(0)
        ...
        if len(student_models) > 0:
            ...
            create_denoising_comparison_plot(
                ...
                config,
                save_dir=config.denoising_dir,
                fixed_samples=fixed_test_samples[:args.num_denoising_samples]
            )
